...
local default_npc_progress
local default_npc_progress_teeming
...
function config:init()
  ...
  if MythicPlusTimerDB.config["npc_progress"] == nil then
    MythicPlusTimerDB.config["npc_progress"] = default_npc_progress
  end

  if MythicPlusTimerDB.config["npc_progress_teeming"] == nil then
    MythicPlusTimerDB.config["npc_progress_teeming"] = default_npc_progress_teeming
  end
